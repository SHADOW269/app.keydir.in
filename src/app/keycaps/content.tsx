...
export default function KeycapsContent({ banners = [], totalCount = 0 }: { banners?: Banner[]; totalCount?: number }) {
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/keycaps?${p.toString()}`);
  ...
  return (
    <div className="catalog-layout">
      ...
      <div className="catalog-page">
        {totalCount === 0 ? (
          <EmptyCategory category="Keycaps" />
        ) : (
          <>
            ...
            {loading ? (
              ...
              <div className="catalog-empty">
                ...
                <div className="catalog-empty-title">No Keycaps Found</div>
      ...
      <SubmitProductCTA productType="keycap" />
